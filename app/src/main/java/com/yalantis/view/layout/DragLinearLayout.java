package com.yalantis.view.layout;
...
// TODO: need handle background for draggable item
public class DragLinearLayout extends LinearLayout {
    ...
    public interface OnViewSwapListener {
         ...
         */
        void onSwapBefore(View firstView, int firstPosition, View secondView, int secondPosition);

        /**
         * Invoked right after drag event was finished.
         */
        void onSwapAfter();
    }
    ...
    /**
     * The currently dragged item, if {@link com.yalantis.view.layout.DragLinearLayout.DragItem#detecting}.
     */
    ...
    // TODO: replace with other drawables
/*    *//**
    ...
    *//**
    ...
    public DragLinearLayout(Context context, AttributeSet attrs) {
        ...
        // TODO: use some other drawable for Draggable view
/*
...
*/
     ...
     */
    public void addDragView(View child, View dragHandle, int position) {
    ...
    /**
     * See {@link com.yalantis.view.layout.DragLinearLayout.OnViewSwapListener}.
     */
     ...
     * {@link com.yalantis.view.layout.DragLinearLayout.DragItem#detecting}.
     */
    ...
    private void onDragStop() {
        ...
        draggedItem.settleAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                // TODO: handle draggable background
/*
...
*/
    ...
    private void onDrag(final int offset) {
        ...
        if (isBelow || isAbove) {
            ...
            if (swapListener != null) {
                swapListener.onSwapBefore(draggedItem.view, draggedItem.position, switchView, switchPosition);
            }
...
*/
    ...
    public boolean onTouchEvent(@NonNull MotionEvent event) {
        switch (MotionEventCompat.getActionMasked(event)) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                // If Touch is outside Layout - stop dragging
                if (lastEventY < 0 || lastEventY > getHeight()) {
                    ...
                    // Setting Delta between start point and last touch point
                    onDrag(lastEventY - downY);
                }
    ...
    /**
     * Helper method for getting all childs in a List
     *
